function [fullmat, itemwise, embedcor] = correlation_analysis(final, perm, meta_tbl, options)
    ...
    fprintf("1) Results\n")
    fprintf("----------\n")
    [final, meta_tbl] = prepare_data_table(final, meta_tbl, ...
      window_type = window_type, ...
      average_predicted_embeddings = average_predicted_embeddings, ...
      bootstrap_averaged_embeddings = bootstrap_averaged_embeddings, ...
      cvscheme = cvscheme, ...
      scale_singular_vectors = scale_singular_vectors);
    fprintf("\n2) Permutations\n")
    fprintf("---------------\n")
    [perm, meta_tbl] = prepare_data_table(perm, meta_tbl, ...
      window_type = window_type, ...
      average_predicted_embeddings = average_predicted_embeddings, ...
      bootstrap_averaged_embeddings = bootstrap_averaged_embeddings, ...
      cvscheme = cvscheme, ...
